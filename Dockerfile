FROM ghcr.io/gythialy/golang-cross-builder:v1.17.7-0
...
# install goreleaser
ARG GORELEASER_VERSION=1.4.1
ARG GORELEASER_SHA=bb3457df09ababddd0cfaf636178791dda80f6bbe2535605568321a0978325ca
RUN  \
