...
FROM ghcr.io/gythialy/golang-cross-builder:v1.24.0-0-${OS_CODENAME:-bookworm}
...
ARG GOLANG_DIST_SHA=dea9ca38a0b852a74e81c26134671af7c0fbe65d81b0dc1c5bfe22cf7d4c8858
# update golang
RUN \
