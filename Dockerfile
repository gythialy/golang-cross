FROM ghcr.io/gythialy/golang-cross-builder:v1.17.5-0
...
# install goreleaser
ARG GORELEASER_VERSION=1.2.4
ARG GORELEASER_SHA=d957108d306f0e039613a2f629a14e9bf3a5d35eda3f68d88964cc5f847ad89f
RUN  \
